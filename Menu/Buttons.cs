    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Menu Settings [2]
                ...
                new ButtonInfo { buttonText = "Disable Enabled VR GUI", overlapText = "Disable Arraylist VR GUI", enableMethod =() => showEnabledModsVR = false, disableMethod =() => showEnabledModsVR = true, toolTip = "Disables the GUI that shows the enabled mods on VR.", legal = true},
                new ButtonInfo { buttonText = "Disable Enabled PC GUI", overlapText = "Disable Arraylist PC GUI", enableMethod =() => showEnabledModsPC = false, disableMethod =() => showEnabledModsPC = true, toolTip = "Disables the GUI that shows the enabled mods on PC.", legal = true},
                new ButtonInfo { buttonText = "Disable Version GUI", enableMethod =() => disableVersionGUI = true, disableMethod =() => disableVersionGUI = false, toolTip = "Disables the GUI on PC that shows the menu version and discord link.", legal = true},
                new ButtonInfo { buttonText = "Disable Room Status GUI", enableMethod =() => disableRoomStatusGUI = true, disableMethod =() => disableRoomStatusGUI = false, toolTip = "Disables the GUI on PC that shows what room your in.", legal = true},
                new ButtonInfo { buttonText = "Disable Control GUI", enableMethod =() => disableControlGUI = true, disableMethod =() => disableControlGUI = false, toolTip = "Disables the GUI on PC that allows you to change your name, color, etc.", legal = true},
